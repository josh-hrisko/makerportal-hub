...
**Status (2026-07-15):** Fourier epicycles shipped and verified live (drawing capture, DFT, animated reconstruction, term slider all tested in-browser). Superseded/extended same day by D-019 (Live Earth) for the geospatial/weather/satellite tools specifically.
